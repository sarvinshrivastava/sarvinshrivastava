...
#### 🔧 SAGE-CLI
> AI-assisted command-line automation tool to streamline developer workflows like scaffolding, task execution, and environment setup. Built with modular agent-based architecture for extensibility.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&labelColor=1a1a1a&color=3776AB) ![Agentic AI](https://img.shields.io/badge/Agentic%20AI-FF6B6B?style=flat-square&labelColor=1a1a1a&color=FF6B6B)

[**↗ GitHub**](https://github.com/sarvinshrivastava/SAGE-CLI)

---

#### 🌐 Pardarsh
> Full-stack e-governance transparency platform to track and visualize government project execution data. Features role-based modules for contractors and citizens with document uploads, ratings, and real-time updates.

![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&labelColor=1a1a1a&color=61DAFB) ![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&labelColor=1a1a1a&color=FFCA28) ![Figma](https://img.shields.io/badge/Figma-F24E1E?style=flat-square&labelColor=1a1a1a&color=F24E1E) ![Flutter](https://img.shields.io/badge/Flutter-02569B?style=flat-square&labelColor=1a1a1a&color=02569B) ![Node](https://img.shields.io/badge/Node-339933?style=flat-square&labelColor=1a1a1a&color=339933)

[**↗ GitHub**](https://github.com/pardarsh-portal)

---

#### 🥽 HomeVision
> AR-based system that converts 2D architectural blueprints into 3D models. Uses OpenCV for data extraction and Blender for modeling, targeting offline Android automation.

![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&labelColor=1a1a1a&color=5C3EE8) ![Blender](https://img.shields.io/badge/Blender-E87D0D?style=flat-square&labelColor=1a1a1a&color=E87D0D) ![Unity](https://img.shields.io/badge/Unity-000000?style=flat-square&labelColor=1a1a1a&color=000000) ![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&labelColor=1a1a1a&color=61DAFB) ![Node](https://img.shields.io/badge/Node-339933?style=flat-square&labelColor=1a1a1a&color=339933)

[**↗ GitHub**](https://github.com/sarvinshrivastava/Home-Vision)

---

#### 🌐 Chalk
> A group expense splitting app built for India — on-device OCR for any bill type, one-tap UPI settlement, bank SMS intelligence for auto-confirming payments, and a personal monthly expense tally.
...
<details>
<summary>Show all (3)</summary>

#### 🤖 Persona-Driven Document Intelligence
> Document analysis system that parses PDFs and ranks content sections based on persona-specific job relevance for AI tools. Implements content classification and scoring logic for targeted users.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&labelColor=1a1a1a&color=3776AB) ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&labelColor=1a1a1a&color=2496ED) ![PyMuPDF](https://img.shields.io/badge/PyMuPDF-CC2936?style=flat-square&labelColor=1a1a1a&color=CC2936)

[**↗ GitHub**](https://github.com/sarvinshrivastava/Persona-driven-PDF-Extractor.git)

---

#### 🥽 Compass
> Android compass app for Android devices with AR overlay for directional labels. Built with Kotlin and Jetpack Compose, featuring FOV-aware label positioning and azimuth smoothing.

![Kotlin](https://img.shields.io/badge/Kotlin-7F52FF?style=flat-square&labelColor=1a1a1a&color=7F52FF) ![Jetpack Compose](https://img.shields.io/badge/Jetpack%20Compose-4285F4?style=flat-square&labelColor=1a1a1a&color=4285F4)

[**↗ GitHub**](https://github.com/sarvinshrivastava/minimal-compass)

---

#### 🥽 AR Circuit Visualizer
> Augmented reality system for visualizing electronic circuits in 3D, enabling interactive exploration of circuit components and connections.

![Unity](https://img.shields.io/badge/Unity-000000?style=flat-square&labelColor=1a1a1a&color=000000) ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&labelColor=1a1a1a&color=239120) ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&labelColor=1a1a1a&color=5C3EE8) ![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&labelColor=1a1a1a&color=FFCA28)
